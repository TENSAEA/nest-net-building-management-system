...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password !== $confirm_password) {
        ...
        $sql = "INSERT INTO xionbms_users (username, password, email, fullname, groupid, role) VALUES (?, ?, ?, ?, ?, ?)"; // Update this line
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ssssss", $username, $hashed_password, $email, $fullname, $groupid, $role); // Update this line
                     ...
                     <div class="card card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
                        <div class="card-body">
                           <a href="../../dashboard/index.php" class="navbar-brand d-flex align-items-center mb-3">
                              ...
                              <h4 class="logo-title ms-3">Nest-Net
                           </a>
                           <h2 class="mb-2 text-center">Sign Up</h2>
                           <p class="text-center">Create your Nest-Net</p>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="groupid" name="groupid" placeholder=" ">
            </div>
        </div>
