...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM xionbms_users WHERE username = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            // $_SESSION['photo'] = $row['photo']; // Assuming you have a 'photo' field in your table
                     ...
                     <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        <div class="card-body z-3 px-md-0 px-lg-4">
                           <a href="../../dashboard/index.php" class="navbar-brand d-flex align-items-center mb-3">
                              ...
                              <h4 class="logo-title ms-3">Nest-Net Building
                           </a>
