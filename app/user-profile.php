        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href=".../../dashboard/index.php/penality.php">
                            <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12 2L2 12h10v10h4V12h10L12 2z" fill="currentColor"></path>
                                </svg>
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <div class="d-flex flex-wrap align-items-center mb-3 mb-sm-0">
                                <h4 class="me-2 h4"><?php echo $user['username']; ?></h4>
                            </div>
                        </div>
                    </div>
                    <form method="POST" action="update-profile.php" class="mt-4">
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="groupid" name="groupid" value="<?php echo $user['groupid']; ?>">
                                </div>
                            </div>
                            <div class="col-lg-6 mb-3">
                                <div class="form-group">
