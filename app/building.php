...
// Fetch building data from the database with pagination
$sql = "SELECT * FROM building LIMIT $start_from, $limit";
  ...
  <body class="  ">
    ...
    <div class="logo-mini">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="./building.php">
                                    <i class="icon">
                                        <svg  class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
      ...
      <div class="card-header d-flex justify-content-between">
                    ...
                    <?php if ($role === 'admin'): ?>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addBuildingModal">Add Building</button>
                    <?php endif; ?>
                    </div>
        <div class="card-body">
    ...
    <tbody>
        ...
        foreach ($buildings as $building) {
            ...
            if ($role === 'admin') {
                echo "<button class='btn btn-sm btn-primary' data-bs-toggle='modal' data-bs-target='#editBuildingModal' data-id='" . htmlspecialchars($building['building_id'] ?? '', ENT_QUOTES, 'UTF-8') . "'>
                        <i class='fas fa-edit'></i>
                      </button>
                      <button class='btn btn-sm btn-danger' onclick='deleteBuilding(" . htmlspecialchars($building['building_id'] ?? '', ENT_QUOTES, 'UTF-8') . ")'>
            ...
            echo "<td data-label='Building Name'>" . htmlspecialchars($building['building_name'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>";
            echo "<td data-label='Trade Name'>" . htmlspecialchars($building['trade_name'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>";
            echo "<td data-label='Address'>" . htmlspecialchars($building['address'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>";
            echo "<td data-label='Tel No'>" . htmlspecialchars($building['tel_no'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>";
            echo "<td data-label='Email'>" . htmlspecialchars($building['email'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>";
            echo "<td data-label='PO Box'>" . htmlspecialchars($building['pobox'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>";
            echo "<td data-label='TIN No'>" . htmlspecialchars($building['tin_no'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>";
            echo "<td data-label='Floors No'>" . htmlspecialchars($building['floors_no'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>";
            echo "<td data-label='Added Date'>" . htmlspecialchars($building['added_date'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>";
            echo "</tr>";
            $i++;
        }
        ?>
          ...
          <div class="modal-body">
            <form id="addBuildingForm">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="buildingName" name="building_name" required>
              </div>
              <!-- Trade Name -->
              <div class="mb-3">
                <label for="tradeName" class="form-label">Trade Name</label>
                <input type="text" class="form-control" id="tradeName" name="trade_name" required>
              </div>
              <!-- Address -->
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="telNo" name="tel_no" required>
              </div>
              <!-- Email -->
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="tinNo" name="tin_no" required>
              </div>
              <!-- Floors No -->
              <div class="mb-3">
                <label for="floorsNo" class="form-label">Floors No</label>
                <input type="number" class="form-control" id="floorsNo" name="floors_no" required>
              </div>
              <!-- Submit Button -->
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="editBuildingForm">
              ...
              <!-- Building Name -->
              <div class="mb-3">
                <label for="edit_buildingName" class="form-label">Building Name</label>
                <input type="text" class="form-control" id="edit_buildingName" name="building_name" required>
              </div>
              <!-- Trade Name -->
              <div class="mb-3">
                <label for="edit_tradeName" class="form-label">Trade Name</label>
                <input type="text" class="form-control" id="edit_tradeName" name="trade_name" required>
              </div>
              <!-- Address -->
              <div class="mb-3">
              ...
              <!-- Tel No -->
              <div class="mb-3">
                <label for="edit_telNo" class="form-label">Tel No</label>
                <input type="text" class="form-control" id="edit_telNo" name="tel_no" required>
              </div>
              <!-- Email -->
              <div class="mb-3">
              ...
              <!-- PO Box -->
              <div class="mb-3">
                <label for="edit_pobox" class="form-label">PO Box</label>
                <input type="text" class="form-control" id="edit_pobox" name="pobox" required>
              </div>
              <!-- TIN No -->
              <div class="mb-3">
                <label for="edit_tinNo" class="form-label">TIN No</label>
                <input type="text" class="form-control" id="edit_tinNo" name="tin_no" required>
              </div>
              <!-- Floors No -->
              <div class="mb-3">
                <label for="edit_floorsNo" class="form-label">Floors No</label>
                <input type="number" class="form-control" id="edit_floorsNo" name="floors_no" required>
              </div>
              <!-- Submit Button -->
    ...
    <script>
      ...
      // Handle Edit Building Modal Show Event
      document.getElementById('editBuildingModal').addEventListener('show.bs.modal', function (event) {
        var button = event.relatedTarget;
        var buildingId = button.getAttribute('data-id');
        // Fetch building data and populate the form fields
      ...
      // Function to Fetch Building Data and Populate the Edit Form
      function fetchBuildingData(buildingId) {
        fetch(`get_building.php?id=${buildingId}`)
          .then(response => response.json())
          .then(data => {
            if (data) {
              document.getElementById('edit_building_id').value = data.building_id;
              document.getElementById('edit_buildingName').value = data.building_name;
              document.getElementById('edit_tradeName').value = data.trade_name;
              document.getElementById('edit_address').value = data.address;
              document.getElementById('edit_telNo').value = data.tel_no;
              document.getElementById('edit_email').value = data.email;
              document.getElementById('edit_pobox').value = data.pobox;
              document.getElementById('edit_tinNo').value = data.tin_no;
              document.getElementById('edit_floorsNo').value = data.floors_no;
            } else {
          ...
          .catch(error => {
            ...
            alert('An error occurred while fetching the building data.');
          });
      }
