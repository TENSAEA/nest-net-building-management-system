...
// Fetch banks data from the database with pagination
$sql = "SELECT * FROM banks LIMIT $start_from, $limit";
  ...
  <body class="  ">
    ...
    <div class="logo-mini">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="./banks.php">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
      ...
      <div class="card-header d-flex justify-content-between">
                    ...
                    <?php if ($role === 'admin'): ?>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addBankModal">Add Bank</button>
                    <?php endif; ?>
                    </div>
        <div class="card-body">
    ...
    <tbody>
        ...
        foreach ($banks as $bank) {
            ...
            if ($role === 'admin') {
                echo "<button class='btn btn-sm btn-primary' data-bs-toggle='modal' data-bs-target='#editBankModal' data-id='" . htmlspecialchars($bank['id'] ?? '', ENT_QUOTES, 'UTF-8') . "'>
                        <i class='fas fa-edit'></i>
                      </button>
                      <button class='btn btn-sm btn-danger' onclick='deleteBank(" . htmlspecialchars($bank['id'] ?? '', ENT_QUOTES, 'UTF-8') . ")'>
            ...
            echo "<td data-label='Name'>" . htmlspecialchars($bank['name'] ?? '', ENT_QUOTES, 'UTF-8') . "</td>";
            echo "</tr>";
            $i++;
        }
        ?>
    ...
    <script>
      ...
      // Handle Edit Bank Modal Show Event
      document.getElementById('editBankModal').addEventListener('show.bs.modal', function (event) {
        ...
        // Fetch bank data and populate the form fields
      ...
      // Function to Fetch Bank Data and Populate the Edit Form
      function fetchBankData(bankId) {
        fetch(`get_bank.php?id=${bankId}`)
          ...
          .catch(error => {
            ...
            alert('An error occurred while fetching the bank data.');
          });
      }
