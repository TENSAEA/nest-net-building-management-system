...
$sql = "SELECT permission, value FROM permissions WHERE role = ?";
$stmt = $conn->prepare($sql);
            ...
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="./company-info.php">
                            <i class="icon">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <?php else: ?>
                                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addCompanyModal" disabled>Add Company</button>
                                <?php endif; ?>
                            </div>
                            <div class="card-body">
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<tr>
                                    ...
                                    <td data-label='Logo'><img src='{$row['logo']}' alt='Logo' width='50'></td>
                                    <td data-label='TIN No'>{$row['tin_no']}</td>
                                    <td data-label='Actions'>";
                            if ($_SESSION['role'] == 'admin') {
                                echo "<button class='btn btn-sm btn-success edit-btn' data-id='{$row['id']}' data-bs-toggle='modal' data-bs-target='#editCompanyModal'>
                                ...
                                echo "<button class='btn btn-sm btn-success edit-btn' data-id='{$row['id']}' data-bs-toggle='modal' data-bs-target='#editCompanyModal' disabled>
                                        <i class='fas fa-edit'></i>
                                      </button>
                                      <button class='btn btn-sm btn-danger delete-btn' data-id='{$row['id']}' disabled>
                                        <i class='fas fa-trash'></i>
                                      </button>";
                            }
                            echo "</td></tr>";
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="addCompanyForm" method="POST" action="add_company.php" enctype="multipart/form-data">
                <!-- Form fields for adding company info -->
                <div class="mb-3">
      ...
      <div class="modal fade" id="editCompanyModal" tabindex="-1" aria-labelledby="editCompanyModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="editCompanyForm" method="POST" action="edit_company.php" enctype="multipart/form-data">
    ...
    button.addEventListener('click', function() {
      ...
      fetch(`get_company.php?id=${id}`)
        ...
        .then(data => {
          ...
          document.getElementById('edit_tin_no').value = data.tin_no;
          // If logo is not null, handle it accordingly
          if (data.logo) {
  ...
  document.querySelectorAll('.delete-btn').forEach(button => {
    button.addEventListener('click', function() {
      ...
      if (confirm('Are you sure you want to delete this company?')) {
        fetch(`delete_company.php?id=${id}`, { method: 'DELETE' })
          .then(response => response.json())
          .then(data => {
            if (data.success) {
              location.reload();
